                ...
                <form onSubmit={handlePhoneSubmit} className="space-y-4">
                  <div>
                    ...
                    {phoneTouched && !phoneInput && (
                      <div className="text-red-500 text-sm mt-1">กรุณากรอกเบอร์โทรศัพท์</div>
                    )}
                  </div>
                  <button type="submit"
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-4">
                  <div>
                    ...
                    {emailTouched && !emailInput && (
                      <div className="text-red-500 text-xs mt-1">กรุณากรอกอีเมล</div>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
                    ...
                    {passwordTouched && !passwordInput && (
                      <div className="text-red-500 text-xs mt-1">กรุณากรอกรหัสผ่าน</div>
                    )}
                  </div>
